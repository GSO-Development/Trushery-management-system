...
<div class="space-y-6" x-data="{
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <a href="{{ route('group.dashboard') }}" class="px-4 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold transition-colors self-start sm:self-auto">
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-5">
        <form id="comparison-filter-form" method="GET" action="{{ route('group.comparison') }}" class="space-y-5">
